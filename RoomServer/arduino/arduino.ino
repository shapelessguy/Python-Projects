...
void sendLightStrip(String c){
  ...
  if (c == "I1") { IrSender.sendNEC(0x0, 0x48, 1); }
  else if (c == "I2") { IrSender.sendNEC(0x0, 0x4C, 1); }
  else if (c == "I3") { IrSender.sendNEC(0x0, 0x1F, 1); }
  else if (c == "I4") { IrSender.sendNEC(0x0, 0x1B, 1); }

...
void sendLightStrip(String c){
  ...
  else if (c == "TOPB3") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 1); delay(100); c="B3"; }
  else if (c == "TOPR0") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 2); delay(100); c="R0"; }

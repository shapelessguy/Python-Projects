...
void sendLightStrip(String c){
  ...
  else if (c == "TOP") { IrSender.sendNEC(0xEF00, 0x02, 1); }
  else if (c == "TOPCOL") { IrSender.sendNEC(0xEF00, 0x03, 1); }
  else if (c == "TOPB3") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 1); c="B3"; }
  else if (c == "TOPR0") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 2); c="R0"; }
  else if (c == "TOPG0") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 3); c="G0"; }
  else if (c == "TOPB0") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 4); c="B0"; }
  else if (c == "TOPR4") { IrSender.sendNEC(0xEF00, 0x14, 1); IrSender.sendNEC(0xEF00, 0x7, 5); c="R4"; }
  else if (c == "TOPG4") { IrSender.sendNEC(0xEF00, 0x14, 1); c="G4"; }

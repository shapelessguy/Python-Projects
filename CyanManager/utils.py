...
VOICES_PATH = os.path.join(os.path.dirname(__file__), 'voices')
...
CYAN_LAUNCHER_PATH = os.path.join(TOOLS_PATH, "CyanLauncherProjects", "CyanLauncherManager", "bin", "Release", "CyanLauncherManager.exe")
CYAN_LAUNCHER_PATH = os.path.join(TOOLS_PATH, "CyanLauncherProjects", "CyanLauncherManager", "bin", "Release", "CyanLauncherManager.exe")
